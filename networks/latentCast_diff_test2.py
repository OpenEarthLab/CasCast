...
class latentCast_diff_test2(nn.Module):
...
if __name__ == "__main__":
    ...
    model = latentCast_diff_test2(**backbone_kwargs)
    model.to(device)
    print('end')
...
# srun -p ai4earth --kill-on-bad-exit=1 --quotatype=auto --gres=gpu:1 python -u latentCast_diff_test2.py #