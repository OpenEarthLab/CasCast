...
class VideoTokenizer(Module):
    ...
    @torch.no_grad()
    def tokenize(self, video, video_contains_first_frame=False):
        self.eval()
        return self.forward(video, return_codes = True, video_contains_first_frame = video_contains_first_frame)
