...
if __name__ == "__main__":
    ...
    backbone_kwargs = {
        ...
        'depth': 24, 'hidden_size':96, 'patch_size':2, 'num_heads':16,
        }
    }
    model = DiT(**backbone_kwargs)
    model.to(device)
    print('end')
...
# srun -p ai4earth --kill-on-bad-exit=1 --quotatype=auto --gres=gpu:1 python -u DiT.py #