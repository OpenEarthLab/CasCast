...
if __name__ == "__main__":
    ...
    import yaml
    cfg_path = '/mnt/cache/gongjunchao/workdir/radar_forecasting/configs/meteonet/ldm_prediff_pred_128.yaml'
...
## srun -p ai4earth --quotatype=auto --ntasks-per-node=1  --cpus-per-task=4 --gres=gpu:1 python -u prediffNet.py ##