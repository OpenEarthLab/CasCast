...
class latentCast_diff_test1(nn.Module):
...
if __name__ == "__main__":
    ...
    # backbone_kwargs = cfg_params['model']['params']['sub_model']['latentCast_diff_test1']
    ...
    #     'split_num':10, 'single_heads_num':4
    #     }
    # }
    model = latentCast_diff_test1(**backbone_kwargs)
    model.to(device)
    print('end')
...
# srun -p ai4earth --kill-on-bad-exit=1 --quotatype=auto --gres=gpu:1 python -u latentCast_diff_test1.py #