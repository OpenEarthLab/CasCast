...
if __name__ == "__main__":
    ...
    cfg_path = '/mnt/cache/gongjunchao/workdir/radar_forecasting/configs/hko7/TAU.yaml'
    ...
    #     'act_inplace': True
    # }
    backbone_kwargs = cfg_params['model']['params']['sub_model']['TAU']
    model = TAU(**backbone_kwargs)
    model.to(device)
...
# srun -p ai4earth --kill-on-bad-exit=1 --quotatype=auto --gres=gpu:1 python -u TAU.py # 