...
if __name__ == "__main__":
    ...
    cfg_path = '/mnt/cache/gongjunchao/workdir/radar_forecasting/configs/meteonet/EarthFormer_xy.yaml'
    with open(cfg_path, 'r') as cfg_file:
      cfg_params = yaml.load(cfg_file, Loader = yaml.FullLoader)
    backbone_kwargs = cfg_params['model']['params']['sub_model']['EarthFormer_xy']
    ...
    print('end')
    # state_dict = torch.load('/mnt/cache/gongjunchao/workdir/empty/EarthForcasting/output/best_net.pth', map_location=torch.device('cpu'))
    model = EarthFormer_xy(**backbone_kwargs)
...
# srun -p ai4earth --kill-on-bad-exit=1 --quotatype=auto --gres=gpu:1 python -u earthformer_xy.py #