...
class mcvd_diffusion_scaleImg_model(basemodel):
    ...
    def denoise(self, template_data, cond_data, bs=1):
        ...
        np.save('scaleImgDenoise.npy', latents_list.cpu().numpy())
        return latents
    ...
    def train_one_step(self, batch_data, step):
        ...
        if self.visualizer_type is None:
            ...
            sample_prediction = scale_sample_prediction / self.noise_scale
