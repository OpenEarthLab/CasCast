...
class mcvd_diffusion_clamp_model(basemodel):
    ...
    def train_one_step(self, batch_data, step):
        ...
        ## scale to [-1, 1] ##
        scale_coarse_prediction = (coarse_prediction - 0.5) * 2.0
        scale_tar = (tar - 0.5) * 2.0 
        ...
        if self.visualizer_type is None:
            ...
            sample_prediction = scale_sample_prediction / 2.0 + 0.5
