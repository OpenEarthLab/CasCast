...
class latent_diffusion_direct_pred_model(basemodel):
    ...
    def eval_step(self, batch_data, step):
        ...
        ## sample image ##
        losses = {}
        z_sample_prediction = self.denoise(template_data=z_tar, cond_data=z_prev_inp, bs=tar.shape[0], vis=True, cfg=1.01, ensemble_member=5)
