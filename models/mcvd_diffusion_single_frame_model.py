...
class mcvd_diffusion_single_frame_model(basemodel):
    ...
    def train_one_step(self, batch_data, step):
        ...
        ### use single frame ###
        scale_tar = scale_tar[:, -1:, ...]
        scale_coarse_prediction = scale_coarse_prediction[:, -1:, ...]
        ## sample noise to add ##
        ...
        if self.visualizer_type is None:
            ...
            scale_sample_prediction = self.denoise(template_data=scale_tar, cond_data=scale_coarse_prediction, bs=1)
