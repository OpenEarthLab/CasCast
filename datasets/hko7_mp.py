...
def print_list_to_txt(lst, filename):
...
if __name__ == '__main__':
    ...
    dataset = data_hko_mp(split='test', input_length=10, pred_length=10, base_freq=base_freq)
    print(len(dataset))
...
### srun -p ai4earth --kill-on-bad-exit=1 --quotatype=reserved --gres=gpu:0 python -u hko7_mp.py ###
