...
class hko7_preprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        packed_results = dict()
        packed_results['inputs'] = frame_data.unsqueeze(0)
        packed_results['data_samples'] = frame_data.unsqueeze(0)
...
if __name__ == '__main__':
    ...
    dataset = hko7_preprocess(split='test', input_length=1, pred_length=0, base_freq=base_freq)
...
### srun -p ai4earth --kill-on-bad-exit=1 --quotatype=reserved --gres=gpu:0 python -u hko7_preprocess.py ###
